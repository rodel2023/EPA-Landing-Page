...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
  ...
  <main id="main">
    ...
    <section id="hero" class="hero-about" style="padding: 6rem 0 0 !important;">
      <img src="assets/img/bg1.png" alt="" data-aos="fade-in">
        <div class="container text-center">
          <h2 data-aos="fade-up">
            About Us!
          </h2>
        <hr data-aos="fade-up" class="hr-mid-nav">
        </div>
    ...
    <section id="services" class="services">
      ...
      <div class="container pt-3 pb-3" data-aos="fade-up" data-aos-delay="100">
